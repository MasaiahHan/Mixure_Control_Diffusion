...
- [ ] try is we can load normal image as a depth image (i guess probably not)
- [ ]  do we need to resize image so that its width and height the same as region? Or put this step in the preprocess stage instead of put it in the mixture?
